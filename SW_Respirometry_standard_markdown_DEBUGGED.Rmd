...
require("knitr")
opts_knit$set(root.dir = "C:/Users/carol/Documents/PhD Boston University 2019-/Doubling Time Experiment/")
```
...
data <- read_csv("Run5_6_20_23_Oxygen.csv", skip=12, na=c("No Sensor","NA"))
...
#selecting columns with data and then subtract the average repiration rate from column with negative control
...
resp_info <- read.csv("TEMPLATE Resp run #5 6.20.23.csv", header=TRUE) # NUMBER ORDER, NOT LETTER ORDER
...
NEG.O2.data<- na.omit(data[c(27, 3)])
...
#BIG FOR LOOP
#NOTE: this for loop starts at B1, what should be the positive oxygen control
...
write.csv(output_temp, "OUTPUT_Doubling_time_Run5_Oxygen.csv", row.names=FALSE)
